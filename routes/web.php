...
use App\Http\Controllers\{FrontendController, CustomerController, HomeController, ProfileController, CategoryController, ColorController, VariationsController, ProductController, Sociallite, InventoryController};
...
Route::get('product/inventory/{id}', [InventoryController::class, 'inventory'])->name('product.inventory');
